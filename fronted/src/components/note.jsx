...
const Notes = () => {
    const [notes, setNotes] = useState([
        { noteId: 1, title: 'Note 1', content: 'This is the first note.', subject: 'Math', lastEditedBy: 'User A' },
        { noteId: 2, title: 'Note 2', content: 'This is the second note.', subject: 'Science', lastEditedBy: 'User B' },
    ]);
    ...
    return (
        ...
        >
            <h1 style={{ textAlign: 'center', color: '#333' }}>Your Notes</h1>
